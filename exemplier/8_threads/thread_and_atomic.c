...
/**
 * @author https://modelingwithdata.org/arch/00000175.htm
 */

/**
 * @file thread_and_atomic.c
 *
 * A simple program using threads and atomic.
 *
 * Compile using: CFLAGS="-g -Wall -O3 --std=c11 -pthread -latomic"
 */
#include <pthread.h>
#include <stdatomic.h>
